...
supplied by the <code class="highlighter-rouge">registry</code> config parameter.  See <a href="/commands/npm-config"><code class="highlighter-rouge">npm config</code></a>,
