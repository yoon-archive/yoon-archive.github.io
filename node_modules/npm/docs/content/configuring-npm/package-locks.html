...
<p>Conceptually, the “input” to <a href="/commands/npm-install"><code class="highlighter-rouge">npm install</code></a> is a <a href="/configuring-npm/package-json">package.json</a>, while its
